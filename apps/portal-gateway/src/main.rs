...
async fn serve(cfg: PortalConfig, logger: Arc<JsonLogger>, layers: String, check_only: bool) -> ExitCode {
    ...
    let portal_state =
        PortalState { system: state.clone(), upstream_base_url: cfg.portal.upstream_base_url.into() };
