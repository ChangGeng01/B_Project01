...
| 编号 | 原登记 | 在等什么 | 谁能定 |
|---|---|---|---|
| 己-1 | 附录己二 | cgroup 九行三列配额表进不进认证冻结范围。仓库当前站在「删除」一侧，五处已删；恢复则 `00b`、`00-overview`、阶段 1、13、14 五处同批回滚 | 产品负责人 |
| 己-3 | 附录己二 | 四端真机 PoC 首测归哪个阶段。三处计划同层各说各话，是排期与资源决策 | 排期决策方 |
| 己-5 | 附录己二 | 规格第 7.7 章「三项遏制手段缺一不得启用」是否放宽为降级启动。本轮已定「计划让步、恢复规格口径」这一支；若改采阶段 14 的主张，须先修订规格第 7.7 与 21.21 两章并同批修订基线第 0 节优先级条款 | 产品负责人 + 安全负责人 |
