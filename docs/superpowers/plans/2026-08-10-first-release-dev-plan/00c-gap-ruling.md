...
- **P1-2（采购订单状态机缺两条边）未落**：起草被驳，且起草方另提两个衍生问——
...
其中 **67 个严格早于 first_due、11 个不早于**，全集中在 6 行。
...
- **F-50 至 F-53 四段没有「本轮未做到的」欠账小节**（全卷该小节 23 处，这四段一处没有；F-54 有）。
...
- `configdoc` 312 处、`eventcatalog` 117 处**仍未逐条消化**，只有 F-58 的状态登记。
