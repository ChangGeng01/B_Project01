...
U-E-12 合同终止的处置口径、U-H-07 更正凭证入口、U-H-08 手工凭证入口、
U-D-02 资金单据冲正、U-D-09 部分红冲、U-A-08 默认审批链与审批人角色、
「冗余」指哪一种、「深度配置」的落点在哪一层、移动端写入的拒绝点、
备份保留期取值、「碾压」的可判定判据。

**十条一条都不得按任一读法推进。** 其中「冗余」与「深度配置」两条是词义澄清，
不澄清后面所有讨论都会走偏，优先级最高。
