...
> **F-62 注：上句为该段作成时点的状态。按本文件首行横幅与 F-57 权威登记，「可直接开发」已被 F-57 撤销（register RULING-AUTHORITY-01），现行开发授权状态为 `README:8` 逐字 `READY_NOT_AUTHORIZED`；F-52–F-54 三段并已降为历史裁决证据。**
>
